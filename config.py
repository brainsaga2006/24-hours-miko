...
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "This video/Photo/anything is available on the internet. We @pookielinks or its subsidiary channel doesn't produce any of them.")
